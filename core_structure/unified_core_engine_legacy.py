"""
Unified Core Engine - DEPRECATED
=================================

⚠️  DEPRECATION WARNING ⚠️
This engine contains embedded strategy-specific logic and fallback mechanisms
that violate clean architecture principles. 

ARCHITECTURAL ISSUES:
- 300+ lines of strategy logic embedded in core orchestration
- Momentum/mean-reversion processing contaminating core engine  
- Import-dependent fallback behavior creating non-deterministic runtime
- Duplicate logic across strategy and core layers

MIGRATION PATH:
Use UnifiedCoreEngine instead, which implements pure delegation pattern.

TIMELINE:
- Phase 1: Extract strategy logic ✅ COMPLETE
- Phase 2: Migrate to clean engine ✅ READY
- Phase 3: Deprecate this engine 🔄 IN PROGRESS
- Phase 4: Remove after migration complete

See: ARCHITECTURE_MIGRATION_PLAN.md for details

Author: Pro Quant Trading System (Legacy)
Version: 2.0 (DEPRECATED - Use UnifiedCoreEngine)
"""

import warnings
warnings.warn(
    "UnifiedCoreEngine is deprecated due to embedded strategy logic. "
    "Use UnifiedCoreEngine for clean architecture pattern.",
    DeprecationWarning,
    stacklevel=2
)
