...
# Temporary definitions until template system is properly consolidated
@dataclass
...
class BaseTemplate:
    """Temporary base template class"""
    def __init__(self, template_id: str):
        self.template_id = template_id
        self.parameter_bounds = {}
    
    def get_parameter_bounds(self, param_name: str) -> Optional[ParameterBounds]:
        return self.parameter_bounds.get(param_name)

def get_trade_engine_template_registry():
    """Temporary template registry function"""
    return {}
