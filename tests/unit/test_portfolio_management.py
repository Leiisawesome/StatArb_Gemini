...
class TestPositionManager:
    ...
    def test_get_portfolio_summary(self, position_manager):
        ...
        pos1_id = position_manager.open_position("AAPL", PositionType.LONG, Decimal('100'), Decimal('150.00'), "strat1")
        pos2_id = position_manager.open_position("GOOGL", PositionType.LONG, Decimal('50'), Decimal('2500.00'), "strat1")
