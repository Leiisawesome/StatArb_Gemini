"""
Regime-Aware Tests for Enhanced Breakout Strategy
==================================================
...
class TestBreakoutRegimeAwareness:
    ...
    @pytest.mark.asyncio
    async def test_high_volatility_affects_breakouts(self, strategy):
        """Test that high volatility affects breakout signal quality"""
        await strategy.initialize()
