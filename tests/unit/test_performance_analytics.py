...
from core_engine.analytics.performance.attribution_engine import (
    AttributionEngine, AttributionMethod, AttributionLevel, AllocationEffect,
    AttributionResult, AttributionConfig
)
from core_engine.analytics.performance.benchmark_tracker import (
    BenchmarkTracker, BenchmarkType, BenchmarkData, RelativePerformanceMetrics
)
from core_engine.analytics.performance.drawdown_tracker import (
    DrawdownTracker, DrawdownType, DrawdownEvent, UnderwaterMetrics
)
from core_engine.analytics.performance.monitor import (
    PerformanceMonitor, PerformanceAlert, PerformanceReport, SystemHealthStatus
)
from core_engine.analytics.performance.performance_calculator import (
    PerformanceCalculator, PerformancePeriod, ReturnType, PerformanceFrequency,
    PerformanceMetrics
)
...
from core_engine.analytics.performance.risk_adjusted_metrics import (
    RiskAdjustedMetrics, RiskMetricType, RiskAdjustmentMethod
)
...
class TestPerformanceAnalyticsIntegration:
    ...
    def test_full_performance_analysis(self, sample_integration_data):
        ...
        benchmark_returns = sample_integration_data['benchmark_returns']
