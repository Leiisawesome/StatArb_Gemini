...
class CoreEnginePerformanceValidator:
    ...
    async def _validate_throughput_performance(self) -> Dict[str, Any]:
        ...
        if 'data_manager' in self.components:
            ...
            try:
                ...
                measurements = self.throughput_benchmarker.benchmark_sync_operation(config)
        ...
        if 'risk_manager' in self.components:
            ...
            try:
                ...
                measurements = await self.throughput_benchmarker.benchmark_async_operation(config)
    ...
    async def _perform_integrated_analysis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            throughput_measurements = self.throughput_benchmarker.generate_throughput_report()
