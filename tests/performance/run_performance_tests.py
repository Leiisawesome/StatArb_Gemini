...
from tests.performance.performance_test_suite import PerformanceTestSuite, run_performance_tests
...
async def run_component_tests(component_name: str):
    ...
    try:
        ...
        throughput_report = throughput_benchmarker.generate_throughput_report()
